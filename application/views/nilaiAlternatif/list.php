...
<form id="form-pairwise-alternatif">
	<div style="">
        <div class="tableFixHead">
            <table class="table table-bordered ">
                ...
                <tr>
                    ...
                    <?php }?>
                    <th style="min-width:50px">Alternatif</th>
                </tr>
                </thead>
                <tbody>
...
var btn_save = $( '.save-button' ).ladda();
	$(document).ready(function(){
        ...
        $('#form-pairwise-alternatif').submit(function(e) {
            e.preventDefault();
            submit_data();
        });
	});
	...
	swal({
		...
		if (isConfirm) {
			...
			$.ajax({
				type: "POST",
				url: site_url+"nilaiAlternatif/submitData/"+kriteria_selected,
				data: $('#form-pairwise-alternatif').serialize(),
				dataType: 'json',
